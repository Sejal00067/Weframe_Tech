    ...
    return (
        <>
          ...
          <div className="relative mt-[-108px] flex">
            <div className="container-xs flex justify-center gap-[18px] 1g:px-5 md:flex-col md:px-5">
                <div className="flex rounded-[20px] bg-gray-50">
                    <Img
                      ...
                      height={300}
                      alt="Buffet Image"
                      className="h-[300px] w-full rounded-[20px] object-cover 1g:h-auto md:h-auto"
                    />
                </div>
                <div className="flex-1 rounded-[20px] bg-gray-50 p-[26px] md:self-stretch sm:p-4">
                    <div className="mb-6 flex flex-col gap-5">
                        <div className="flex flex-col items-start gap-1">
                            ...
                            > 
                              <span className="text-gray-800"> S&apos;inscrire & économiser&nbsp;</span>
                              <span className="text-cyan-300_01">10%&nbsp;</span>
                            </Heading>
                            <Text as="p" className="w-full text-[14px] font-medium leading-[22px] text-gray-400">
                        ...
                        className="min-w-[166px] gap-2 rounded-1g px-[22px] font-cabinetgrotesk font-bold uppercase sm:px-4"
                    >
                        S&apos;inscrire
                    </Button>
                </div>
